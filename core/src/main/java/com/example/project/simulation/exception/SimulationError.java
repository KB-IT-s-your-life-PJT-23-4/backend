...
public enum SimulationError {
    ...
    INVALID_CUSTOM_PORTFOLIO_REQUEST(HttpStatus.BAD_REQUEST, "INVALID_CUSTOM_PORTFOLIO_REQUEST", "커스텀 포트폴리오 요청이 올바르지 않습니다."),
    INVALID_CUSTOM_PORTFOLIO_ALLOCATION(HttpStatus.BAD_REQUEST, "INVALID_CUSTOM_PORTFOLIO_ALLOCATION", "상품 유형별 비율은 5% 단위이며 합계가 100%여야 합니다."),
    ...
    INVALID_CUSTOM_PORTFOLIO_STATUS(HttpStatus.CONFLICT, "INVALID_CUSTOM_PORTFOLIO_STATUS", "임시 저장 상태의 시뮬레이션에서만 비율을 조정할 수 있습니다."),
    CUSTOM_PORTFOLIO_BASE_MISMATCH(HttpStatus.CONFLICT, "CUSTOM_PORTFOLIO_BASE_MISMATCH", "추천된 기본 포트폴리오를 확인할 수 없습니다."),
    ...
    CUSTOM_PORTFOLIO_UPDATE_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "CUSTOM_PORTFOLIO_UPDATE_FAILED", "커스텀 포트폴리오 계산 또는 저장 중 오류가 발생했습니다.");
